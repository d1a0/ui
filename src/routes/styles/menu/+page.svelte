<script>
	import Shell from '$docs/Shell.svelte';

	const settings = {
		name: 'Menu',
		description: 'Menus list items, mainly used as navigators.',
		examples: [
			{
				title: 'Menu',
				description: '',
  ...
  <ul>
    ...
    <li><a href="/guides/typography">Typography</a></li>
			...
			},
			{
				...
				description: 'Text shows up only on screen size greater than 1024px.',
				code: `<nav class="menu">
  <ul>
    <li>
      <a>
